...
const features = [
  {
    n: "01",
    title: "Invoice kilat",
    desc: "Item dinamis dengan perhitungan total otomatis. Nomor invoice ter-generate sendiri.",
  },
  {
    n: "02",
    title: "Share WhatsApp",
    desc: "Kirim link invoice ke pelanggan langsung lewat WhatsApp dalam sekali klik.",
  },
  {
    n: "03",
    title: "Ekspor PDF",
    desc: "Download invoice sebagai PDF profesional yang siap cetak atau kirim email.",
  },
  {
    n: "04",
    title: "Data pelanggan",
    desc: "Simpan pelanggan sekali, pakai berulang. Tak perlu ketik ulang tiap menagih.",
  },
  {
    n: "05",
    title: "Lacak status",
    desc: "Pantau invoice draft, terkirim, lunas, atau jatuh tempo dalam satu layar.",
  },
  {
    n: "06",
    title: "Branding sendiri",
    desc: "Upgrade ke Pro untuk hapus watermark dan tampilkan identitas bisnismu.",
  },
];
    ...
    <div className="grain min-h-screen bg-paper text-ink">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <nav className="flex items-center gap-5">
          {session ? (
            <Link
              href="/dashboard"
              className="rounded-full bg-ink px-5 py-2.5 text-sm font-medium text-paper transition-colors hover:bg-emerald"
            >
              Dashboard
            </Link>
          ) : (
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-6 pb-24 pt-12 lg:grid-cols-2 lg:gap-8 lg:pt-20">
        <div>
          ...
          <h1
            className="rise mt-6 font-display text-5xl font-semibold leading-[1.05] tracking-tight sm:text-6xl"
            style={{ animationDelay: "0.1s" }}
          >
            Tagih pelanggan,{" "}
            <span className="italic text-emerald">tanpa ribet.</span>
          </h1>
          <p
            className="rise mt-6 max-w-md text-lg leading-relaxed text-ink-soft"
            style={{ animationDelay: "0.2s" }}
          >
            Bikin dan kirim invoice profesional dalam 30 detik. Rapi, bisa
            di-PDF, langsung share ke WhatsApp pelanggan.
          </p>
          <div
          ...
          >
            <Link
              href="/register"
              className="rounded-full bg-emerald px-7 py-3.5 text-sm font-semibold text-paper shadow-lg shadow-emerald/20 transition-all hover:bg-emerald-bright hover:shadow-emerald/30"
            >
              Mulai Gratis
            </Link>
            <a
              href="#fitur"
              className="text-sm font-medium text-ink underline decoration-line decoration-2 underline-offset-4 transition-colors hover:decoration-emerald"
            >
              Lihat cara kerjanya
            </a>
          </div>
          <p
            className="rise mt-6 text-xs text-ink-soft"
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-4 -left-2 hidden rotate-[-8deg] rounded-lg border-2 border-ochre/40 px-3 py-1 sm:block">
            <span className="font-display text-xs font-bold uppercase tracking-widest text-ochre/70">
              Paid
            </span>
          </div>
        </div>
          ...
          <div className="mt-14 grid grid-cols-1 gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div key={f.n} className="group">
                <span className="tnum font-display text-sm font-semibold text-emerald">
                  {f.n}
                </span>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mt-3 text-center text-ink-soft">
            Mulai gratis. Upgrade kalau bisnismu tumbuh.
          </p>
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-line bg-white p-8">
              ...
              <Link
                href="/register"
                className="mt-8 block rounded-full border border-ink px-5 py-3 text-center text-sm font-semibold text-ink transition-colors hover:bg-ink hover:text-paper"
              >
                Mulai Gratis
              </Link>
            </div>
            ...
            <div className="relative rounded-2xl bg-ink p-8 text-paper">
              ...
              <Link
                href="/register"
                className="mt-8 block rounded-full bg-emerald px-5 py-3 text-center text-sm font-semibold text-paper transition-colors hover:bg-emerald-bright"
              >
                Coba Pro
              </Link>
            </div>
      ...
      <section className="border-t border-line bg-paper-deep py-20">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mt-4 text-ink-soft">
            Gabung dengan UMKM yang sudah menagih lebih rapi dengan NotaKu.
          </p>
          <Link
            href="/register"
            className="mt-8 inline-block rounded-full bg-emerald px-8 py-4 text-sm font-semibold text-paper shadow-lg shadow-emerald/20 transition-all hover:bg-emerald-bright"
          >
