...
export default function RegisterPage() {
  ...
  4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 bg-blue-600 text-white rounded-md cursor-pointer hover:bg-blue-700
  disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <button
          ...
          className="w-full py-2 px-4 border border-gray-300 rounded-md cursor-pointer hover:bg-gray-50 flex
  items-center justify-center gap-2 text-gray-700"
        >
