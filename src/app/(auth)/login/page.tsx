      ...
      <main className="w-full max-w-md mx-auto my-auto py-6">
        <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-xl shadow-slate-200/40">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-xs font-bold text-[#0f6b4f] hover:text-[#0c553e] hover:underline"
                >
                  {t.auth?.forgotPassword || (locale === "id" ? "Lupa kata sandi?" : "Forgot password?")}
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-xs text-slate-500 mt-6 font-medium">
            {t.auth?.noAccount || (locale === "id" ? "Belum punya akun NotaKu?" : "Don't have a NotaKu account?")}{" "}
            <Link
              href="/register"
              className="text-[#0f6b4f] hover:text-[#0c553e] font-bold hover:underline"
            >
