 import { auth } from "@/lib/auth"
      ...
      <div>
        ...
        {!allowed ? (
          <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-5">
            <p className="font-medium text-amber-800">Batas invoice gratis tercapai</p>
            <p className="mt-1 text-sm text-amber-700">
              Kamu sudah membuat {used}/{limit} invoice bulan ini.
  ...
  hover:bg-amber-700 transition-colors"
          ...
          <>
            <p className="mt-1 text-sm text-gray-500">{used}/{limit} invoice bulan ini</p>
            <div className="mt-6">
